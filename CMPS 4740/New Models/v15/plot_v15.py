...
def plot_training(opponent):
    ...
    print(f"Plotting V15 data from: {log_file}")
    ...
    ax1.set_title(f'V15 Win Rates vs {opponent.upper()}')
    ax1.legend()
    ax1.grid(True)
    ...
    plot_path = os.path.join(PLOT_DIR, f"v15_results_{opponent}_{timestamp}.png")
